...
export const MyWorkTimeline: TimelineItem[] = [
  {
    ...
    description:
      '<p>During my time in Time Inc UK (Previously Time & Warner). ' +
  ...
  },
  {
    ...
    position: 'Web developer',
    description:
      '<p>I was responsible to develop new technologies to ' +
  ...
  },
  {
    ...
    position:
      '<a href="http://berlioz.dis.ulpgc.es/roc-siani/publicaciones-principal/pdfs/memoria-pfc-eduardo-aparicio-cardenes-jul-2011.pdf" rel="nofollow" target="_blank">' +
      'Odometry error reduction in a mobile robot using scan ' +
      'matching algorithms based in laser sensor range</a>',
    description:
      '<p>The MbICP is a variant of the ICP algorithm (Iterative ' +
  ...
  },
  {
    ...
    description:
      '<p>I started my professional career in my last year ' +
  ...
  },
  {
    ...
    description:
      '<p>I developed as a Software Engineer with knowledge in ' +
